...
const equipments1 = {
  ...
  equip: [
    'Циклон SN50T3 - 1 шт',
    'Циклон второй ступени фильтрации - 1 шт',
    'Соединительный кронштейн - 1 шт',
    'Муфта 50-56 - 2 шт',
    'Хомут 42-58 - 2 шт',
    'Фланец крепления - 1 шт',
...
const equipments2 = {
  ...
  subheader: 'Комплектация',
  equip: [
    'Насадка на циклонный фильтр - 1 шт',
    'Муфта 50-56мм - 2 шт',
    'Крепёжный болт, гайка, шайба - 4 шт',
  ],
}
